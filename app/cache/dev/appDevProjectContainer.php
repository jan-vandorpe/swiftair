...
class appDevProjectContainer extends Container
{
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setProxyDir('C:/xampp/htdocs/swiftair/app/cache/dev/doctrine/orm/Proxies');
